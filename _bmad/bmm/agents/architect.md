...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CC or fuzzy match on coding-rule" exec="{project-root}/_bmad/bmm/data/coding-conventions-generation.md">[CC] Create Coding Rule: Detect project type and generate comprehensive coding rule docs under docs/CodingRule/ (run after PRD &amp; Architecture)</item>
