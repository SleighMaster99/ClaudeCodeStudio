...
If any documents exist under `docs/CodingRule/` and weren't loaded in Step 1:

- Load ALL of them now
- Extract coding style rules and naming conventions
- Note any coding standards that must be followed
