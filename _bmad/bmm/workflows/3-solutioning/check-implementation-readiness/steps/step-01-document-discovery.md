...
- Index: `{planning_artifacts}/epics.md` (epic list with file links - standard structure)
- Epic detail files: `{epics_artifacts}/epic-*.md` (one file per epic with stories)
- Legacy whole document: `{planning_artifacts}/*epic*.md` (single file containing all epics and stories)

**NOTE:** The index + epic detail files combination is the standard structure, NOT a duplicate. Treat them as one logical document set.
