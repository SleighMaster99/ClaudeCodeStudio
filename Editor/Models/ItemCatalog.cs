...
public static class ItemCatalog
{
    ...
    public static readonly IReadOnlyList<ItemTypeInfo> All = new ItemTypeInfo[]
    {
        ...
        new("fable_pct",       "페이블 %",           "12%",            "페이블 주간 한도 사용률", "사용률"),
        new("fable_bar",       "페이블 막대 █",      "█▒▒▒▒▒▒▒▒▒",     "페이블 주간 블록 그래프", "사용률"),
        new("fable_bar_ascii", "페이블 막대 [#]",    "[#---------]",   "페이블 주간 ASCII 그래프","사용률"),
        new("fable_bar_dot",   "페이블 막대 ●",      "●○○○○○○○○○",     "페이블 주간 점 그래프",   "사용률"),
        ...
        new("fable_remain",    "페이블 남은시간",     "~1d07h",         "페이블 주간 초기화까지 남은시간", "사용률"),
        // 아이콘
        ...
        new("icon_fable",   "페이블 아이콘",   "🔮",  "페이블 사용률 항목 앞", "아이콘"),
        // 구분자/포맷
